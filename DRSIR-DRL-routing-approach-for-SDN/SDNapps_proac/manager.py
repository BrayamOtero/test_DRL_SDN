...
class Manager(app_manager.RyuApp):
    ...
    def write_values(self):
        ...
        if self.delay is not None:
            ...
            with open('/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/net_info.csv','wb') as csvfile:
    ...
    def get_k_paths_metrics_dic(self,shortest_paths,bwd_links,delay_links,loss_links):
        ...
        with open('/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/paths_metrics.json','w') as json_file:
