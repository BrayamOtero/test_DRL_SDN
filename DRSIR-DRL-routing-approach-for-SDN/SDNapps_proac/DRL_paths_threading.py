...
sys.path.insert(1,'/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/RoutingGeant/DRL/dRSIR/23nodos')
import agent
...
def get_paths_base():
    file_base = '/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/DRL/dRSIR/'+str(num_nodes)+'nodos/paths_weight.json'
...
def get_paths_DRL():
    file_DRL = '/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/drl_paths.json'
...
def calc_all_stretch(cont):
    ...
    a = time.time()
    with open('/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/stretch/'+str(cont)+'_stretch.csv','w') as csvfile:
...
def get_all_paths(episode_rewards, episode_states_all, episode_duration_all, episodes):
    ...
    file = '/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/DRL/dRSIR/'+str(len(env.topo_nodes))+'nodos/k_paths.json'
...
def DRL_thread(): #cambiar para que lo llame a drl
    ...
    file_info_eps = "/home/brayam/Tesis/Daniela/DRSIR-DRL-routing-approach-for-SDN/SDNapps_proac/episode_info.txt"
